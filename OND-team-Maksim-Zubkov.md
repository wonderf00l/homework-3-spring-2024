## Вкладка "Аудитории"
* При нажатии на вкладку "Аудитории" в сайдбаре открывается [страница аудиторий](https://ads.vk.com/hq/audience), нужна авторизация
...
* При нажатии на кнопку "Cохранить" новая аудитория появляется в списке существующих аудиторий на странице "Создание аудиторий" 
* При нажатии на вкладку "Существующая аудитория" окно "Включить источник" заменяется на окно "Существующая аудитория" с выпадающим списком "Аудитория"
* При нажатии на вкладку "Список пользователей" окно "Включить источник" заменяется на окно "Список пользователей" с разделами "Выбрать существующий" и "Загрузить новый". По умолчанию открывается раздел "Выбрать существующий", в котором отображается дропдаун "Список пользователей".
* При выборе раздела "Загрузить новый" отображаются поле ввода "Название", чекбокс "Как имя файла", дропдаун "Тип списка" и форма для загрузки файла.

## Настройки

Лид-формы. Настройки. При нажатии на чекбокс "Уведомлять о новых заявках по email" появится поле "Email-адреса"

Лид-формы. Настройки. При введении email-адреса, не соответствующему формату корректного email-адреса(цифры, символы латинского алфавита, спец. символ @), появится сообщение "Неверный email"
...
Настройки. Уведомления. При нажатии на "Отменить", изменения, внесенные в одном из разделов "Способы получения", "Основные", "Новости и акции", сбросятся

Настройки. Уведомления. При нажатии "Сохранить", изменения, внесенные в одном из разделов "Способы получения", "Основные", "Новости и акции", сохранятся
...
---
![](assets/poll_1.png)
- Создание опроса. Оформление. Ввести название "test poll". Название отображается в форме предпросмотра.
- Создание опроса. Оформление. Загрузить логотип. Логотип отображается в форме предпросмотра.
- Создание опроса. Оформление. Ввести название компании "test corp". Название компании отображается в форме предпросмотра.
- Создание опроса. Оформление. Ввести заголовок опроса "test header". Заголовок опроса отображается в форме предпросмотра.
- Создание опроса. Оформление. Ввести описание опроса "test description". Описание опроса отображается в форме предпросмотра.
![](assets/poll_2.png)
- Создание опроса. Вопросы. Ввести текст вопроса "how do you do?". Текст вопроса отображается в форме предпросмотра.
- Создание опроса. Вопросы. Ввести текст ответа "great". Текст ответа отображается в форме предпросмотра.
...
![](assets/poll_3.png)
- Создание опроса. Результат. Ввести заголовок "Спасибо за ответы". Текст заголовка отображается в форме предпросмотра.
- Создание опроса. Результат. Ввести описание "Заявка отправлена". Текст описания отображается в форме предпросмотра.
- Создание опроса. Результат. Добавить ссылку "https://vk.com/feed". Ввести ссылку. В форме предпросмотра появляется кнопка "Перейти на сайт" с введенной ссылкой.
- Создание опроса. Результат. Сохранить опрос. Опрос отображается в общем списке опросов, название опроса совпадает с названием, указанным на шаге "Оформление".
![](assets/res.png)
- Создание опроса. Перейти в список опросов. Опрос с названием "test poll" отображается в списке опросов.
- Создание опроса. Проверка введенных данных опроса. Данные, введенные на предыдущих шагах, совпадают с данными, которые отображаются при просмотре созданного опроса.
