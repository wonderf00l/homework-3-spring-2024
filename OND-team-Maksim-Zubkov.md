...
- Навести на опрос. Открыть выпадающее меню на три точки. Выбрать "Редактировать". Открывается аналогичное меню создания с предзаполненными полями, совпадающими с ранее заполненными значениями.
- Навести на опрос. Открыть выпадающее меню на три точки. Выбрать "Дублировать". В списке опросов появляется копия опроса с названием "<название опроса> (копия)".
